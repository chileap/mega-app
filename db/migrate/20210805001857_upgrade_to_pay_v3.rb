class UpgradeToPayV3 < ActiveRecord::Migration[6.0]
  ...
  def self.up
    ...
    MODELS.each do |klass|
      remove_column :accounts, :processor
      remove_column :accounts, :processor_id
      remove_column :accounts, :pay_data, if_exists: true
      remove_column :accounts, :card_type
      remove_column :accounts, :card_last4
      remove_column :accounts, :card_exp_month
      remove_column :accounts, :card_exp_year
