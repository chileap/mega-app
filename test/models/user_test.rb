...
class UserTest < ActiveSupport::TestCase
  test "user has many workspaces" do
    user = users(:one)
    assert_includes user.workspaces, workspaces(:one)
    assert_includes user.workspaces, workspaces(:company)
  end

  test "user has a personal workspace" do
    user = users(:one)
    assert_equal workspaces(:one), user.personal_workspace
  end

  test "can delete user with workspaces" do
