...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: "div", class: "flex w-full border-0 border-b border-gray-200 focus-within:border-indigo-600" do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :input, class: "border-0 w-full py-2 px-0 bg-white shadow-none focus:ring-0 focus:border-0 text-sm", error_class: "border-b-red-500", valid_class: "border-b-green-400"
  ...
  config.wrappers :vertical_textarea, tag: "div", class: "flex w-full" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
    b.optional :readonly
    b.use :label, class: "block", error_class: "text-red-500"
    b.use :input, class: "border border-gray-200 w-full p-2 bg-white focus:ring-0 text-sm", error_class: "border-red-500", valid_class: "border-green-400"
    b.use :full_error, wrap_with: {tag: "p", class: "mt-2 text-red-500 text-xs italic"}
    b.use :hint, wrap_with: {tag: "p", class: "mt-2 text-grey-700 text-xs italic"}
  end
  ...
  config.wrappers :vertical_boolean, tag: "div", class: "flex items-start", error_class: "" do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: "opacity-100 align-middle bg-gray-50 border-gray-300 focus:ring-0 h-5 w-5 rounded-sm checked:bg-blue-500"
  ...
  config.wrappers :inline_boolean, tag: "div", class: "flex items-start", error_class: "" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper tag: "label", class: "checkbox" do |bb|
      bb.use :input, class: "mr-2 opacity-100 align-middle bg-gray-50 border-gray-300 focus:ring-0 h-5 w-5 rounded-sm checked:bg-blue-500"
      bb.use :label_text, class: "block", error_class: "text-red-500"
      bb.use :hint, wrap_with: {tag: "p", class: "block text-grey-700 text-xs italic"}
      bb.use :full_error, wrap_with: {tag: "p", class: "block text-red-500 text-xs italic"}
    end
  end
