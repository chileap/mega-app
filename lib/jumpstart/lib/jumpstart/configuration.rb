...
module Jumpstart
  class Configuration
    ...
    def initialize(options = {})
      ...
      self.personal_workspaces = true if personal_workspaces.nil?
    end
    ...
    def register_with_workspace=(value)
      @register_with_workspace = ActiveModel::Type::Boolean.new.cast(value)
    end

    def register_with_workspace?
      @register_with_workspace.nil? ? false : ActiveModel::Type::Boolean.new.cast(@register_with_workspace)
    end
    ...
    def personal_workspaces=(value)
      @personal_workspaces = ActiveModel::Type::Boolean.new.cast(value)
    end

    def personal_workspaces
      # Enabled by default
      @personal_workspaces.nil? ? true : ActiveModel::Type::Boolean.new.cast(@personal_workspaces)
    end
