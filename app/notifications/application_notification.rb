class ApplicationNotification < Noticed::Base
  ...
  # Include the user's personal workspace by default, but allow overriding with params
  def to_database
    {
      workspace: params[:workspace] || recipient.personal_workspace,
      type: self.class.name,
      params: params.except(:workspace)
    }
  end
