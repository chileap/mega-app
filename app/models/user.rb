...
class User < ApplicationRecord
  ...
  has_many :meal_templates, through: :favorite_meal_templates
  ...
  # Scopes
  scope :connected_account, ->(provider) { joins(:connected_accounts).where(user_connected_accounts: {provider: provider}) }
  ...
  def update_preferences(params)
    preferences(:view_options).set(params)
    preferences(:view_options).reload
  end
end
