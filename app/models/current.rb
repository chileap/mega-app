...
# Current should only be used for a few, top-level globals, like workspace, user, and request details.
...
class Current < ActiveSupport::CurrentAttributes
  attribute :user, :workspace, :request_id, :user_agent, :ip_address
