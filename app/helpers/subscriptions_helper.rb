module SubscriptionsHelper
  ...
  def show_payment_processor?(processor_name, plan: nil)
    ...
    if current_workspace.subscriptions.active.any? && current_workspace.payment_processor
      ["fake_processor", processor_name.to_s].include?(current_workspace.payment_processor.processor)
